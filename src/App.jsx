...
const postKey = 'price-review-compare.posts'
const savedKey = 'price-review-compare.saved'
const items = [
  {
    "id": "price-review-compare-1",
    "title": "Nagoya hotel opportunity",
    "category": "hotel",
    "area": "Nagoya",
    "summary": "Price, review, coupon and stock comparison media for high-intent local and product searches. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 92,
    ...
    "revenue": "Success-fee affiliate"
  },
  {
    "id": "price-review-compare-2",
    "title": "Tokyo food opportunity",
    "category": "food",
    "area": "Tokyo",
    "summary": "Price, review, coupon and stock comparison media for high-intent local and product searches. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 85,
    ...
    "revenue": "verified listing ads"
  },
  {
    "id": "price-review-compare-3",
    "title": "Osaka amusement opportunity",
    "category": "amusement",
    "area": "Osaka",
    "summary": "Price, review, coupon and stock comparison media for high-intent local and product searches. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 78,
    ...
    "revenue": "coupon lead gen"
  }
]
const revenuePlans = [
  "Success-fee affiliate",
  "verified listing ads",
  "coupon lead gen",
  "review reports",
  "sponsored comparison slots"
]
const buzzIdeas = [
...
function App() {
  ...
  const [form, setForm] = useState({ title: '', category: 'hotel', body: '' })
  ...
  function submitPost(event) {
    ...
    setForm({ title: '', category: 'hotel', body: '' })
  }
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <span className="brand">reviewhikaku.jp / price-review-compare</span>
          <h1>Price Review Compare</h1>
          <p>Price, review, coupon and stock comparison media for high-intent local and product searches.</p>
        </div>
        <aside className="answer-box">
          <small>AI overview answer</small>
          <strong>Price Review Compare helps users compare, verify and act faster.</strong>
      ...
      <section className="ugc-section">
        ...
        <form className="ugc-form" onSubmit={submitPost}>
          ...
          <select value={form.category} onChange={(event) => setForm({ ...form, category: event.target.value })}>
            {["hotel","food","amusement","net cafe","goods"].map((item) => <option key={item}>{item}</option>)}
          </select>
